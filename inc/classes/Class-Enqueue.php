 ...
 */
	...
	class eiser_Enqueue{
		...
		public function eiser_scripts_enqueue_init(){
			add_action( 'wp_enqueue_scripts', array( $this, 'eiser_frontend_enqueue_scripts', ) );
		}

		public function eiser_frontend_enqueue_scripts( ){
