...
// image default alt
if( !function_exists( 'eiser_img_default_alt' ) ){
	function eiser_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'eiser_img_tag' ) ){
	function eiser_img_tag( array $args ){
...
// Anchor Tag
if( !function_exists( 'eiser_anchor_tag' ) ){
	function eiser_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'eiser_heading_tag' ) ){
	function eiser_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'eiser_paragraph_tag' ) ){
	function eiser_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'eiser_other_tag' ) ){
	function eiser_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'eiser_button_element ' ) ){
	function eiser_button_element( array $args ){
