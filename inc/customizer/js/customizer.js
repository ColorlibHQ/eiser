(function( $ , api){
    ...
    api.section( 'eiser_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'eiser_about_section' , function( section ){
    ...
    api.section( 'eiser_blog_section' , function( section ){
    ...
    api.section( 'eiser_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-eiser_contact_custom_formshortcode'),
                selector = $('#_customize-input-eiser_contact_formshortcode');
    ...
    // General section
    api.section( 'eiser_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#eiser_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-eiser_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-eiser_preloader_color' );
            ...
            var $backtotop          = $( '#eiser_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-eiser_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-eiser_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'eiser_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle      = $('#eiser_footer_widget_toggle');
