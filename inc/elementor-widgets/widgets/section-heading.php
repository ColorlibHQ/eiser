 ...
 * @since 1.0
 */
class Eiser_sh extends Widget_Base {
	...
	public function get_title() {
		return __( 'Section Heading', 'eiser' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'sh_content',
            [
                'label' => __( 'Section Heading', 'eiser' ),
            ]
        );
        $this->add_control(
            'sh_sectiontitle',
        ...
        $this->add_control(
            'sh_sectionsubtitle',
            [
                'label'       => esc_html__( 'Sub Title', 'eiser' ),
                'label_block' => true,
                'type'        => Controls_Manager::TEXT,
            ]
        );
