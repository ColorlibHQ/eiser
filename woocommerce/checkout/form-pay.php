	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'eiser' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'eiser' ); ?></th>
			</tr>
		</thead>
		<tbody>
