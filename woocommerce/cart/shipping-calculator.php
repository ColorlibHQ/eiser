		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_state', true ) ) : ?>
			<p class="form-row form-row-wide" id="calc_shipping_state_field">
				...
				if ( is_array( $states ) && empty( $states ) ) {
					?>
					<input type="hidden" name="calc_shipping_state" id="calc_shipping_state" placeholder="<?php esc_attr_e( 'State / County', 'eiser' ); ?>" />
					<?php
				} elseif ( is_array( $states ) ) {
					?>
					<select name="calc_shipping_state" class="shipping_select" id="calc_shipping_state" data-placeholder="<?php esc_attr_e( 'State / County', 'eiser' ); ?>">
						<option value=""><?php esc_html_e( 'Select an option&hellip;', 'eiser' ); ?></option>
						<?php
					...
					?>
					<input type="text" class="input-text" value="<?php echo esc_attr( $current_r ); ?>" placeholder="<?php esc_attr_e( 'State / County', 'eiser' ); ?>" name="calc_shipping_state" id="calc_shipping_state" />
					<?php
				}
				?>
			</p>
